...
- 2025-11-16: **Simplified layout with minimal left margin** - Removed frequency scale labels and added small 18px left padding to ensure blue overtone numbers remain visible without wasting space; overtone labels now show just the frequency number without "Hz" suffix
