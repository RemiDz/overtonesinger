...
- 2025-11-16: **Simplified layout with minimal left margin** - Removed frequency scale labels; increased canvas internal left padding to 20px and positioned overtone labels at x=2px (18px left of spectrogram chart area); overtone labels now show just the frequency number without "Hz" suffix; canvas has z-10 stacking to ensure full visibility
